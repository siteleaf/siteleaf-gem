...
ENV['USER_ID'] ||= 'USER_ID'
ENV['SITE_ID'] ||= 'SITE_ID' unless ENV['SITE_ID']
ENV['PAGE_ID'] ||= 'PAGE_ID' unless ENV['PAGE_ID']
ENV['POST_ID'] ||= 'POST_ID' unless ENV['POST_ID']
ENV['SUBPAGE_ID'] ||= 'SUBPAGE_ID' unless ENV['SUBPAGE_ID']
ENV['PARENT_ID'] ||= 'PARENT_ID' unless ENV['PARENT_ID']
